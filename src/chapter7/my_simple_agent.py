...
class MySimpleAgent(BaseAgent):
    ...
    def _run_with_tools(self, messages, input_text, max_tool_iterations, **kwargs) -> str:
        ...
        self._history.append(Message(content=input_text, role="user"))
        self._history.append(Message(content=final_response, role="assistant"))
        print(f"✅ {self.name} 响应完成")
    ...
    def stream_run(self, input_text: str, **kwargs) -> Iterator[str]:
        ...
        # 保存完整对话到历史消息
        self._history.append(Message(content=input_text, role="user"))
        self._history.append(Message(content=full_response, role="assistant"))
